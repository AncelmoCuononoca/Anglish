...
const GREET: LessonDef = {
  ...
  stage1: [
    ...
    { id:6,  type:'write', question:"Translate: 'Até logo!'", options:[], answer:'See you later!', explanation:"'Até logo' = 'See you later' - a casual farewell.", xp:10 },
  ...
  stage2: [
    ...
    { id:12, type:'write', question:"Translate: 'E tu? Como estás?'", options:[], answer:'And you? How are you?', explanation:"'E tu?' = 'And you?' - always ask back after answering 'How are you?'", xp:15 },
  ...
  stage3: [
    ...
    { id:24, type:'write', question:"Translate: 'Há quanto tempo! Como tens passado?'", options:[], answer:"Long time no see! How have you been?", explanation:"'Há quanto tempo' = Long time no see; 'Como tens passado?' = How have you been?", xp:25 },
    ...
    { id:26, type:'write', question:"Translate: 'Espero que esta mensagem te encontre bem.'", options:[], answer:"I hope this message finds you well.", explanation:"Formal email opening: 'I hope this message finds you well.'", xp:25 },
...
const VTB1: LessonDef = {
  ...
  stage1: [
    ...
    { id:6, type:'write', question:"Translate: 'Tu és de Portugal.'", options:[], answer:'You are from Portugal.', accept:["you're from portugal."], explanation:"'You are' - 'you' always uses 'are'.", xp:10 },
  ...
  stage2: [
    ...
    { id:15, type:'write', question:"Translate: 'Nós não somos de Angola.'", options:[], answer:'We are not from Angola.', accept:["we're not from angola.","we aren't from angola."], explanation:"'We are not' - place 'not' after the verb 'to be'.", xp:15 },
  ...
  stage3: [
    ...
    { id:26, type:'write', question:"Translate: 'Se eu fosse tu, ficaria calado.'", options:[], answer:"If I were you, I'd stay quiet.", accept:["if i were you, i would stay quiet."], explanation:"Subjunctive: 'If I WERE you' - formal/literary English uses 'were' for all persons.", xp:30 },
...
const SUBPRON: LessonDef = {
  ...
  stage1: [
    ...
    { id:3, type:'write', question:"Translate: 'Eles são de Angola.'", options:[], answer:'They are from Angola.', accept:["they're from angola."], explanation:"Eles (plural) → They.", xp:10 },
  ...
  stage2: [
    ...
    { id:15, type:'write', question:"Translate: 'Ela e eu somos colegas de trabalho.'", options:[], answer:'She and I are colleagues.', explanation:"Subject pronouns: She and I (not 'me'). When in doubt, remove the other person: 'I am a colleague.'", xp:20 },
  ...
  stage3: [
    ...
    { id:28, type:'write', question:"Translate: 'São eles que têm razão, não somos nós.'", options:[], answer:'It is they who are right, not us.', accept:["it's they who are right, not us."], explanation:"Cleft: 'It is they who...' (formal). After 'not': 'us' (object position).", xp:30 },
...
const NUMS: LessonDef = {
  ...
  stage2: [
    ...
    { id:12, type:'write', question:"How old is someone born in 1995 in 2025?", options:[], answer:'thirty years old', explanation:"2025 - 1995 = 30 years old.", xp:15 },
    ...
    { id:15, type:'write', question:"Translate: 'Somos três irmãos.'", options:[], answer:'There are three of us siblings.', explanation:"'There are three of us' or 'We are three siblings.' - both natural.", xp:15 },
  ...
  stage3: [
    ...
    { id:30, type:'write', question:"Translate: 'Ela está na casa dos trinta.'", options:[], answer:"She is in her thirties.", explanation:"'na casa dos trinta' = in her thirties (aged 30-39).", xp:35 },
  ],
}
...
const CONTRACTIONS: LessonDef = {
  ...
  stage1: [
    ...
    { id:9, type:'write', question:"Translate: 'Eles são amigos.'", options:[], answer:"They're friends.", accept:["they are friends."], explanation:"'They are' → 'They're'.", xp:10 },
  ...
  stage2: [
    ...
    { id:16, type:'write', question:"'You're' vs 'your' - '___ welcome!'", options:[], answer:"You're", accept:["you are"], explanation:"'You're welcome' = 'You are welcome'. 'Your' is possessive.", xp:15 },
  ...
  stage3: [
    ...
    { id:22, type:'write', question:"'_____ been waiting for an hour!' (frustration)", options:[], answer:"I've", accept:["i have"], explanation:"'I've been waiting' = 'I have been waiting' - Present Perfect Continuous.", xp:25 },
...
const COUNTRIES: LessonDef = {
  ...
  stage1: [
    ...
    { id:8, type:'write', question:"'He is from Germany. He is _____.'", options:[], answer:'German', explanation:"Germany → German. Irregular - no suffix, just 'German'.", xp:10 },
  ...
  stage2: [
    ...
    { id:13, type:'write', question:"Translate: 'O meu amigo é japonês.'", options:[], answer:'My friend is Japanese.', explanation:"Japan → Japanese (nationalities are capitalised).", xp:15 },
  ...
  stage3: [
    ...
    { id:23, type:'write', question:"Translate: 'Ela tem dupla nacionalidade.'", options:[], answer:"She has dual nationality.", explanation:"'dupla nacionalidade' = dual nationality.", xp:25 },
    ...
    { id:30, type:'write', question:"Translate: 'Luanda é uma cidade cosmopolita.'", options:[], answer:"Luanda is a cosmopolitan city.", explanation:"'cosmopolita' = cosmopolitan (diverse, international).", xp:35 },
  ],
}
...
const COLORS: LessonDef = {
  ...
  stage1: [
    ...
    { id:5, type:'write', question:"Translate: 'Tenho um telemóvel preto.'", options:[], answer:'I have a black phone.', explanation:"Adjective before noun: 'a black phone'.", xp:10 },
  ...
  stage2: [
    ...
    { id:13, type:'write', question:"Translate: 'Ela tem olhos azuis grandes.'", options:[], answer:'She has big blue eyes.', explanation:"Adjective order: size (big) → colour (blue) → noun.", xp:20 },
  ...
  stage3: [
    ...
    { id:23, type:'write', question:"'She was in a ___ mood all day.' (depressed/sad)", options:[], answer:'blue', explanation:"'Feeling blue' = sad/depressed. 'I've got the blues' = I'm sad/melancholy.", xp:25 },
