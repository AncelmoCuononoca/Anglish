...
const GREET: LessonDef = {
  ...
  stage2: [
    ...
    { id:13, type:'write', question:"'Good ___, how are you?' - meeting at 8pm", options:[], answer:'evening', explanation:"Good evening = boa noite (when greeting). 'Good night' is used only to say GOODBYE at bedtime.", xp:20 },
...
const VTB1: LessonDef = {
  ...
  stage2: [
    { id:11, type:'write', question:"'Is' or 'Are'? - 'There ___ many students in the class.'", options:[], answer:'are', explanation:"'There are' - use 'are' because 'students' is plural.", xp:15 },
  ...
  stage3: [
    ...
    { id:27, type:'write', question:"'The meeting ___ being held tomorrow.' - correct form?", options:[], answer:'is', explanation:"'The meeting IS being held' - passive with Present Continuous.", xp:25 },
...
const SUBPRON: LessonDef = {
  ...
  stage1: [
    ...
    { id:2, type:'write', question:"O gato está a dormir. Em inglês: '___ is sleeping.'", options:[], answer:'It', explanation:"Animais e objetos → It.", xp:10 },
  ...
  stage3: [
    ...
    { id:26, type:'write', question:"'___ is a long way from Luanda to London.' - filler subject?", options:[], answer:'It', explanation:"Filler 'It' for distance: 'It is 6,000km from Luanda to London.'", xp:25 },
...
const NUMS: LessonDef = {
  ...
  stage1: [
    ...
    { id:6, type:'write', question:"Translate: 'O meu pai tem cinquenta e um anos.'", options:[], answer:'My father is fifty-one years old.', explanation:"'Is' (not 'has') for age in English. 51 = fifty-one (hyphen).", xp:10 },
...
const CONTRACTIONS: LessonDef = {
  ...
  stage1: [
    ...
    { id:8, type:'write', question:"Complete: 'This is Ana. _____ a doctor.'", options:[], answer:"She's", accept:["she is"], explanation:"'She is' → 'She's'.", xp:10 },
