...
const GREET: LessonDef = {
  ...
  stage1: [
    ...
    { id:2,  type:'translation', question:"Translate: 'Olá!'", options:['Hello!','Goodbye!','Thank you!','Please!'], answer:'Hello!', explanation:"'Olá' = Hello / Hi - the most basic greeting.", xp:10 },
    ...
    { id:9,  type:'translation', question:"Translate: 'Cuida-te!'", options:['Take care!','Good luck!','No problem!','You\'re welcome!'], answer:'Take care!', explanation:"'Cuida-te' = 'Take care' - a warm farewell.", xp:10 },
  ...
  stage2: [
    ...
    { id:15, type:'translation', question:"Translate: 'Não estou muito bem.'", options:["I'm not very well.",'I am not good.','I feel bad.','I am sick.'], answer:"I'm not very well.", explanation:"'Não estou muito bem' = 'I'm not very well' - the polite way to say you don't feel well.", xp:15 },
    ...
    { id:18, type:'translation', question:"Translate: 'Tenha uma boa semana!'", options:['Have a good week!','Have a nice day!','Good luck this week!','See you next week!'], answer:'Have a good week!', explanation:"'Tenha uma boa semana' = 'Have a good week!' - a warm farewell.", xp:15 },
  ...
  stage3: [
    ...
    { id:27, type:'fill_blank', question:"Formal email closing: 'I look forward to ___ from you.'", options:['hearing','hear','heard','to hear'], answer:'hearing', explanation:"'I look forward to hearing from you' - gerund after 'look forward to'. Most common formal email closing.", xp:30 },
...
const VTB1: LessonDef = {
  ...
  stage1: [
    ...
    { id:3, type:'translation', question:"Translate: 'Nós somos amigos.'", options:['We are friends.','We is friends.','We am friends.','Us are friends.'], answer:'We are friends.', explanation:"'We are' - use 'are' for we/you/they.", xp:10 },
    ...
    { id:9, type:'translation', question:"Translate: 'Ele é médico.'", options:['He is a doctor.','He are a doctor.','He am a doctor.','Him is a doctor.'], answer:'He is a doctor.', explanation:"'He is' - note: English needs 'a doctor' but Portuguese doesn't need the article.", xp:10 },
  ...
  stage2: [
    ...
    { id:12, type:'translation', question:"Translate: 'Ela está cansada.'", options:['She is tired.','She are tired.','She am tired.','Her is tired.'], answer:'She is tired.', explanation:"'Is' for states and conditions with he/she/it.", xp:15 },
    ...
    { id:18, type:'translation', question:"Translate: 'Quantos anos tens?'", options:['How old are you?','How old is you?','What age are you?','How old you are?'], answer:'How old are you?', explanation:"Age in English uses 'to be': How old ARE you? I AM 25.", xp:15 },
  ...
  stage3: [
    ...
    { id:23, type:'translation', question:"Translate: 'Seja o que for.'", options:['Whatever it may be.','Whatever it is.','Be what it is.','It whatever may be.'], answer:'Whatever it may be.', explanation:"Subjunctive: 'may be' expresses uncertainty/generality.", xp:30 },
    ...
    { id:29, type:'translation', question:"Translate: 'Estou a ser observado.'", options:['I am being watched.','I am watched.','I being watched.','I am be watched.'], answer:'I am being watched.', explanation:"Present Continuous Passive: am/is/are + being + past participle.", xp:30 },
...
const SUBPRON: LessonDef = {
  ...
  stage1: [
    ...
    { id:7, type:'translation', question:"Translate: 'Tu és muito inteligente.'", options:['You are very smart.','You is very smart.','He are very smart.','I am very smart.'], answer:'You are very smart.', explanation:"Tu → You (are).", xp:10 },
    ...
    { id:10, type:'translation', question:"Translate: 'Eu e os meus amigos estamos cansados.'", options:['We are tired.','They are tired.','I are tired.','We is tired.'], answer:'We are tired.', explanation:"Eu + amigos = nós → We are tired.", xp:15 },
  ],
  stage2: [
    ...
    { id:12, type:'translation', question:"Translate: 'São eles os teus pais?'", options:['Are they your parents?','Is they your parents?','Are he your parents?','They are your parents?'], answer:'Are they your parents?', explanation:"Eles → They; question: Are they...?", xp:15 },
    ...
    { id:20, type:'translation', question:"Translate: 'Quem somos nós para julgar?'", options:['Who are we to judge?','Who we are to judge?','Who are us to judge?','Who is we to judge?'], answer:'Who are we to judge?', explanation:"'We' is subject → 'Who are we'. Not 'us' (that's object).", xp:15 },
  ],
  stage3: [
    ...
    { id:22, type:'translation', question:"Translate formally: 'Fui eu que telefonei.'", options:['It was I who called.','It was me who called.','I was who called.','It is I called.'], answer:'It was I who called.', explanation:"Cleft sentence: 'It was I who...' - formal. 'It was me' is informal but very common.", xp:25 },
    ...
    { id:25, type:'translation', question:"Translate: 'Que Deus nos ajude.'", options:['May God help us.','May God help we.','God help us.','God helps us.'], answer:'May God help us.', explanation:"After verbs and prepositions: object pronoun 'us' (not 'we'). 'May' = subjunctive for wishes.", xp:25 },
...
const NUMS: LessonDef = {
  ...
  stage3: [
    ...
    { id:28, type:'fill_blank', question:"'A ___ of a kind'", options:['one','two','three','four'], answer:'one', explanation:"'One of a kind' = unique, unlike anything else.", xp:25 },
    { id:29, type:'translation', question:"Translate (idiom): 'Matar dois coelhos de uma cajadada só.'", options:['To kill two birds with one stone.','To kill two rabbits with one shot.','Two birds, one stone.','Both first and third are correct.'], answer:'To kill two birds with one stone.', explanation:"This is the English idiom equivalent. The image differs (birds vs rabbits) but the meaning is identical.", xp:30 },
...
const CONTRACTIONS: LessonDef = {
  ...
  stage1: [
    ...
    { id:2, type:'translation', question:"Translate: 'Ela é professora.'", options:["She's a teacher.", "She are a teacher.", "Her is teacher.", "She teacher."], answer:"She's a teacher.", explanation:"'She is' → 'She's'. We also need 'a' before teacher.", xp:10 },
    ...
    { id:6, type:'translation', question:"Translate: 'Nós somos estudantes.'", options:["We're students.", "We is students.", "We are' students.", "Us are students."], answer:"We're students.", explanation:"'We are' → 'We're'.", xp:10 },
  ...
  stage2: [
    ...
    { id:14, type:'translation', question:"Translate: 'Quem é ela?'", options:["Who's she?","Who is she?","Whos she?","Who she's?"], answer:"Who's she?", explanation:"'Who's' = 'Who is'. The contraction is more natural.", xp:15 },
    ...
    { id:18, type:'translation', question:"Translate naturally: 'Onde estão eles?'", options:["Where're they?","Where they are?","Where are they?","Wheres they?"], answer:"Where're they?", explanation:"'Where are they?' is standard. 'Where're they?' is informal but natural.", xp:15 },
  ...
  stage3: [
    ...
    { id:24, type:'translation', question:"Translate naturally: 'Eu teria ido se soubesse.'", options:["I'd have gone if I'd known.","I will go if I know.","I would went if I knew.","I'd went if I'd known."], answer:"I'd have gone if I'd known.", explanation:"Third conditional: 'I would have gone if I had known' → 'I'd have gone if I'd known.'", xp:30 },
    ...
    { id:30, type:'translation', question:"Translate (expert): 'Não devia ter dito isso, pois não?'", options:["I shouldn't have said that, should I?","I should not say that, isn't it?","I wouldn't say that, should I?","I hadn't said that, had I?"], answer:"I shouldn't have said that, should I?", explanation:"Question tag after negative: 'shouldn't I?' → 'should I?'. Past: 'shouldn't have said'.", xp:35 },
  ],
}
...
const COUNTRIES: LessonDef = {
  ...
  stage1: [
    ...
    { id:3, type:'translation', question:"Translate: 'Eu sou português.'", options:['I am Portuguese.','I am Portugese.','I am Portugish.','I am Portugalist.'], answer:'I am Portuguese.', explanation:"Portugal → Portuguese. One of the irregular forms.", xp:10 },
    ...
    { id:7, type:'translation', question:"Translate: 'O meu amigo é chinês.'", options:['My friend is Chinese.','My friend is Chinish.','My friend is Chinian.','My friend is Chinan.'], answer:'My friend is Chinese.', explanation:"China → Chinese. Ends in -ese.", xp:10 },
  ...
  stage2: [
    ...
    { id:12, type:'translation', question:"Translate: 'Falo quatro línguas: inglês, português, francês e espanhol.'", options:['I speak four languages: English, Portuguese, French and Spanish.','I speak four languages: english, portuguese, french and spanish.','I speak 4 language: English, Portuguese, French and Spanish.','I speak four languages: English, Portugish, French and Spanish.'], answer:'I speak four languages: English, Portuguese, French and Spanish.', explanation:"Languages are always capitalised in English!", xp:15 },
    ...
    { id:16, type:'translation', question:"Translate: 'Qual é a tua nacionalidade?'", options:['What is your nationality?','What is your national?','Which is your nationality?','What nationality are you?'], answer:'What is your nationality?', explanation:"'What is your nationality?' is the standard form. 'What nationality are you?' is also common.", xp:15 },
  ...
  stage3: [
    ...
    { id:28, type:'fill_blank', question:"'She is a _____ national.' (has citizenship of two countries)", options:['dual','double','two','bi'], answer:'dual', explanation:"'Dual national' = person with citizenship of two countries.", xp:25 },
...
const COLORS: LessonDef = {
  ...
  stage1: [
    ...
    { id:2, type:'translation', question:"Translate: 'O céu é azul.'", options:['The sky is blue.','The sky is blue colour.','Sky is blue.','The sky be blue.'], answer:'The sky is blue.', explanation:"'The sky IS blue.' - use 'the' with specific things.", xp:10 },
    ...
    { id:6, type:'translation', question:"Translate: 'O meu carro é verde.'", options:['My car is green.','My car is verde.','My car are green.','My green car is.'], answer:'My car is green.', explanation:"'My car IS green.' Simple!", xp:10 },
  ...
  stage2: [
    ...
    { id:12, type:'translation', question:"Translate: 'Ela usa um lindo vestido vermelho longo.'", options:['She wears a beautiful long red dress.','She wears a red beautiful long dress.','She wears a long beautiful red dress.','All are technically correct in English.'], answer:'She wears a beautiful long red dress.', explanation:"English adjective order: opinion → size → colour → noun.", xp:20 },
    ...
    { id:20, type:'translation', question:"Translate: 'Ela é alta, morena e tem cabelo cacheado.'", options:['She is tall, dark-skinned and has curly hair.','She is tall, dark and has curled hair.','She is high, morena and has curly hair.','She is tall, brunette and has wavy hair.'], answer:'She is tall, dark-skinned and has curly hair.', explanation:"Dark-skinned (morena), curly (cacheado). 'Brunette' means dark hair, not dark skin.", xp:20 },
  ],
  stage3: [
    ...
    { id:22, type:'translation', question:"Translate the idiom: 'Ficar com inveja.' using colour", options:["To turn green with envy.","To become yellow with jealousy.","To go red with anger.","To feel blue."], answer:"To turn green with envy.", explanation:"Green = envy in English. 'Green-eyed monster' = jealousy (Shakespeare).", xp:25 },
    ...
    { id:27, type:'fill_blank', question:"'She was caught ___ handed.' (committing a crime)", options:['red','black','dirty','caught'], answer:'red', explanation:"'Caught red-handed' = caught in the act of doing something wrong.", xp:25 },
