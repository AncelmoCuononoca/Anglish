...
const avatars = [
  ...
  { id: 'adele',   name: 'Adele',   accent: 'British English',     flag: '🇬🇧', voice: 'fable',   color: '#FF006E', photo: '/tutors/adele.png',   desc: 'Elegant British · Conversational', instructions: 'Keep a strong British Received Pronunciation (London / BBC) accent, clearly British and never American. Make the voice as feminine as possible: a young woman, high-pitched, light, soft and delicate, clearly and unmistakably female. Raise the pitch noticeably; never deep, never husky, never masculine.' },
  ...
  { id: 'aiko',    name: 'Aiko',    accent: 'Japanese English',    flag: '🇯🇵', voice: 'shimmer', color: '#FF6B35', photo: '/tutors/aiko.png',    desc: 'Polite & precise · Perfect pace', instructions: 'Speak English with a distinct, authentic Japanese accent, as a native Japanese speaker: gentle, with softened R and L sounds and an even, syllable-timed rhythm, polite and measured. A soft, feminine female voice.' },
  { id: 'priya',   name: 'Priya',   accent: 'Indian English',      flag: '🇮🇳', voice: 'coral',   color: '#9B5DE5', photo: '/tutors/priya.png',   desc: 'Lively Indian English · Expressive', instructions: 'Speak with a strong, authentic Indian English accent, as a native speaker from India: melodic sing-song intonation, crisp retroflex T and D sounds, typical Indian rhythm. Use a high-pitched, light, thin, clearly feminine female voice, never deep.' },
  { id: 'anselmo', name: 'Anselmo', accent: 'EN/PT Coach',         flag: '🇦🇴', voice: 'verse',   color: '#00D4FF', photo: '/tutors/anselmo.png', desc: 'Founder · Bilingual PT/EN coach', instructions: 'Speak in a lighter, slightly higher-pitched baritone male voice, a warm baritone that is clearly NOT a deep bass, raise the pitch a little. Motivating, with a light Angolan Portuguese lilt.' },
]
