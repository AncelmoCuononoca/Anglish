...
const avatars = [
  ...
  { id: 'adele',   name: 'Adele',   accent: 'British English',     flag: '🇬🇧', voice: 'coral',   color: '#FF006E', photo: '/tutors/adele.png',   desc: 'Elegant British · Conversational', instructions: 'Speak with a strong, unmistakable British English Received Pronunciation accent, clearly British and absolutely NOT American. Use a light, high-pitched, soft and distinctly feminine female voice, never deep or husky.' },
  ...
  { id: 'priya',   name: 'Priya',   accent: 'Indian English',      flag: '🇮🇳', voice: 'alloy',   color: '#9B5DE5', photo: '/tutors/priya.png',   desc: 'Lively Indian English · Expressive', instructions: 'Speak with a strong, authentic Indian English accent, as a native speaker from India: melodic, sing-song intonation, crisp retroflex T and D sounds, and the typical rhythm of Indian English. A lively, expressive, clearly feminine female voice.' },
  { id: 'anselmo', name: 'Anselmo', accent: 'EN/PT Coach',         flag: '🇦🇴', voice: 'ash',     color: '#00D4FF', photo: '/tutors/anselmo.png', desc: 'Founder · Bilingual PT/EN coach', instructions: 'Speak in a warm, motivating male voice in a natural baritone range, not a deep bass and not low. A light Angolan Portuguese lilt.' },
]
