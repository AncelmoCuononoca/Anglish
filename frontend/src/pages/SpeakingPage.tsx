...
const avatars = [
  ...
  { id: 'adele',   name: 'Adele',   accent: 'British English',     flag: '🇬🇧', voice: 'fable',   color: '#FF006E', photo: '/tutors/adele.png',   desc: 'Elegant British · Conversational', instructions: 'Speak as a British woman with a strong Received Pronunciation (London / BBC) accent, clearly British and absolutely NOT American. A light, higher-pitched, soft, distinctly feminine female tone, never deep or husky.' },
